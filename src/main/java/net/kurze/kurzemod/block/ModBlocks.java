...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> SCULK_DECO = registerBlock("sculk_deco",
            ()-> new Block(BlockBehaviour.Properties.copy(Blocks.QUARTZ_PILLAR).sound(SoundType.SCULK_CATALYST)));
    //-----------------------------ORES----------------
